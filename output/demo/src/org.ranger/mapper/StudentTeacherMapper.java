...
import org.ranger.mapper.Builder.StudentTeacherBuilder;

/**
 * tb_student_teacher表操作映射接口
 * @author ranger
 *
 */
@Persistent
public interface StudentTeacherMapper {
	 ...
	 * @return
	 */
	@SQL(type=SQLType.INSERT,value="INSERT INTO tb_student_teacher(tea_id)  VALUES (#{tea_id})")
	@Options(backfillParmaryKey=true,columnName="stu_id",propteryName="stu_id")
	int insert(Map<String,Object> entity);
	
	 /**
	  * @Description 批量插入记录 
	  * @param entitis -->(tea_id) 
	  * @return
	  */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="batchInsert")
	 ...
	 * @return
	 */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="deleteByIds")
	 ...
	 * @return
	 */
	@SQL(type=SQLType.DELETE,value="DELETE FROM tb_student_teacher WHERE stu_id=#{id}")
	int deleteById(Object id);
	  ...
	  * @return
	  */
	@SQL(type=SQLType.UPDATE,value="UPDATE tb_student_teacher SET tea_id= #{tea_id} WHERE stu_id=#{stu_id} ")
	int update(Map<String,Object> entity);
	  ...
	  * @return
	  */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="batchUpdate")
	int batchUpdate(List<Map<String,Object>> entitis);
	  ...
	  * @return
	  */
	@SQL(type=SQLType.SELECT,value="SELECT * FROM tb_student_teacher")
	 ...
	 * @return
	 */
	@SQL(type=SQLType.SELECT,value="SELECT * FROM tb_student_teacher WHERE stu_id=#{id}")
	 ...
	 * @return
	 */
	@SQL(type=SQLType.SELECT,type=StudentTeacherBuilder.class,method="findByIds")
	 ...
	 * @return
	 */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="findByEntity")
	 ...
	 * @return
	 */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="count")
	 ...
	 * @return
	 */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="findByEntityLikePage")
	 ...
	 * @return
	 */
	@SQLBuilder(type=StudentTeacherBuilder.class,method="findByEntityLike")
